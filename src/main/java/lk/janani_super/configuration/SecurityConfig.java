package lk.janani_super.configuration;


import lk.janani_super.asset.user_management.service.UserDetailsServiceImpl;
        ...
        http.authorizeRequests(
                authorizeRequests ->
                        authorizeRequests
                                ...
                                .antMatchers("/customer/**").hasAnyRole("CASHIER","MANAGER")
                                .antMatchers("/item/**").hasAnyRole("CASHIER","MANAGER","PROCUREMENT_MANAGER")
                                .anyRequest()
                                .authenticated())
                // Login form
                .formLogin(
